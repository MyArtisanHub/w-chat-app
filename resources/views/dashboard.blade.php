                        ...
                        <table class="table-auto w-full border-collapse border border-grey-300">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class=" border border-grey-300 px-4 py-2 text-left ">Email</th>
                                    <th class=" border border-grey-300 px-4 py-2 text-left ">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($users as $user)
                                <tr>
                                    <td class=" border border-grey-300 px-4 py-2 text-left ">{{ $loop->index + 1 }}</td>
                                    <td class=" border border-grey-300 px-4 py-2 text-left ">{{ $user->name }}</td>
                                    <td class=" border border-grey-300 px-4 py-2 text-left ">{{ $user->email }}</td>
                                    <td class=" border border-grey-300 px-4 py-2 text-left relative">
                                        <a wire:navigate href="{{ route('chat',$user->id) }}">
                                            ...
                                            <span id="unread-count-{{ $user->id }}" class="{{ $user->unread_messages_count > 0 ? 'absolute top-0 right-12 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full' : '' }}">
